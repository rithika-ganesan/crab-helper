...
process.maxEvents = cms.untracked.PSet(input = cms.untracked.int32(__N_EVENTS__))
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('__OUTPUT_FILE_NAME__'), closeFileFast = cms.untracked.bool(True))
